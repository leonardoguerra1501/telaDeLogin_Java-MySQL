        ...
        <div class="container">
		 ...
		 enctype="multipart/form-data">
                        <div class="login-data">
                            <div class="image-profile"><img src="./assets/profile.jpg" alt="Imagem de perfil"></div>
                            ...
                            <div class="container-data">
                                ...
                                <input type="password" name="txtSenha" placeholder="" class="inputSenha">
                            </div>
                            <div class="container-data">
                                <label for="senhaConfirm">Confirme sua senha</label>
                                <input type="password" name="senhaConfirm" placeholder="" class="inputSenha">
                                <div class="divMostrarSenha">
                                    <img src="./assets/eye.svg" alt="exibir senha">
                        ...
                        <div class="personal-data">
                            ...
                            <div class="container-buttons">
                                <a class="button-form" href="./typeAccess.jsp">Cancelar</a>
